...
const KeyboardScene = ({ maxDpr }: { maxDpr: number }) => {
  ...
  const handleMouseHover = (e: SplineEvent) => {
    ...
    if (e.target.name === "body" || e.target.name === "platform") {
      ...
      try {
        ...
        // Some exported Spline scenes omit the expected text variables.
      }
    } else {
  ...
  const handleSplineInteractions = () => {
    ...
    splineApp.addEventListener("keyUp", () => {
      ...
      try {
        ...
        // Some scenes do not expose the text variables.
      }
    });
    splineApp.addEventListener("keyDown", (e) => {
      ...
      if (skill) {
        ...
        try {
          ...
          // Ignore missing Spline text variables.
        }
      }
    });
  ...
  useEffect(() => {
    ...
    try {
      ...
      // Some Spline exports omit the expected text fields.
    }
  }, [selectedSkill]);
    ...
    const manageAnimations = async () => {
      ...
      if (activeSection !== "skills") {
        try {
          ...
          // Some scenes do not contain the text variables.
        }
      }
