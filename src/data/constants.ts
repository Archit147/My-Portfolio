...
export const EXPERIENCE: Experience[] = [
  {
    ...
    company: "Cisco",
    description: [
      "Completed 60+ hours of intensive training across 6+ modules including Network Security, Ethical Hacking, Threat Analysis & Cyber Defense.",
      "Earned Junior Cybersecurity Analyst professional badge by scoring 100% in all assessments, backed by Cisco, AICTE & Ministry of Education.",
      "Gained hands-on experience with Cisco Packet Tracer, network defense tools and threat detection techniques.",
      "Selected among 1 Lakh+ students across India for this future-skills program under Skill India initiative.",
    ],
    skills: [
      SkillNames.LINUX,
      SkillNames.GIT,
  ...
  },
  {
    ...
    company: "RineX",
    description: [
      "Promoted campus events & hackathons to 500+ students via WhatsApp, Instagram & classroom pitching.",
      "Drove 200+ registrations for RineX tech events, achieving 40% increase in campus engagement.",
      "Created and managed targeted outreach campaigns, content creation & peer-to-peer marketing strategies.",
      "Acted as liaison between RineX team and college community, enhancing brand visibility on campus.",
    ],
    skills: [
      SkillNames.REACT,
      SkillNames.VUE,
